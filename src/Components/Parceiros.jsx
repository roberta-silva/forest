...
const Parceiros = () => {
  return (
    <section className="container mb-12 sm:mb-16">
      <ul className="flex flex-col items-center py-4 max-sm:divide-y-2 divide-verde-900 *:p-4 sm:flex-row sm:gap-8 sm:border-b-2 sm:border-t-2 sm:border-verde-900 sm:py-8 *:*:max-h-8">
        <li>
